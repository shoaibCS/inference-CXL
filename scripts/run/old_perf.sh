...
run_one_exp()
{
	...
	perf_events="${perf_events}"",CYCLE_ACTIVITY.STALLS_MEM_ANY,EXE_ACTIVITY.BOUND_ON_STORES,CYCLE_ACTIVITY.STALLS_TOTAL"
...
./modify-uncore-freq.sh 2000000 2000000 20000 20000
echo "Run L100"
run_seq_cxl_L100
echo "Run L0 1"
run_seq_cxl_L0_1
