...
PERF="/home/jinshu/linux/tools/perf/perf"
...
run_one_exp()
{
	...
	perf_events="${perf_events}"",MEM_LOAD_RETIRED.FB_HIT"
...
#	perf_events="${perf_events}"",LONGEST_LAT_CACHE.MISS"
	...
	/home/shoaib/run/mlcc --latency_matrix &>> $state
	/home/shoaib/run/mlcc --bandwidth_matrix &>> $state
